...
namespace Ch18ProductMaintenance_CF
{
    public partial class Default : System.Web.UI.Page
    {
        protected void grdProducts_CallingDataMethods(object sender, CallingDataMethodsEventArgs e)
        {
            e.DataMethodsObject =
                new Ch18ProductMaintenance_CF.Models.ProductDB();
        }
