<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Ch18ProductMaintenance_CF.Default" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Ch18: Product Maintenance</title>
        ...
        <form id="form1" runat="server">
            ...
            <div class="col-sm-6 table-responsive">
                <asp:GridView ID="grdProducts" runat="server" 
                    ...
                    ItemType="Ch18ProductMaintenance_CF.Models.Product" 
                    OnCallingDataMethods="grdProducts_CallingDataMethods" 
                    SelectMethod="GetProducts" SelectedIndex="0"
